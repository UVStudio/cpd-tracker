...
const requiredTotalCPDRules = (
  ...
  const remainingTotalCPDHours = 120 - pastVerHours - pastNonVerHours;
...
From the previous 2 years, you have earned a total of ${totalEarnedHours} CPD hours, which means you will need to earn ${remainingTotalCPDHours} total CPD hours in ${showYear} to satisfy your total CPD hours requirements.
    ...
    setCardText(
      'While you are only required to obtain 20 CPD hours this year, you are encouraged to get earn 20 hours, so you will have an easier time meeting the CPD 3-year rolling requirement in the near future.'
    );
  }
};
